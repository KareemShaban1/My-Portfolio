...
class FrontTemplateController extends Controller
{
    ...
    public function index(){
        ...
        $currentTemplate = Information::where('key','template')->
        select('value')->first();
        ...
        return view('frontend.Template'.$currentTemplate->value.'.pages.index',
        compact('information','projects','categories','homePage','testimonials',
        'portfolioImages','cv_pdf','aboutPage','factsPage','skillsPage','servicesPage','personalExperiences'));
    }
