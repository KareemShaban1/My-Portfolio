...
class TemplateInformationController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $information = Information::where('type', 'template');
        ...
        return view('backend.dashboard.template2.pages.templateInformation.index');
    }
