...
@section('content')
<div class="container">
    <h2 class="mb-4">{{ __('Edit Page') }}</h2>
</div>

<div class="card">
    <div class="card-body">

        <form action="{{ route('pages.update', $page->id) }}" id="pageForm" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="template_id" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="{{ $template->id }}" {{ $template->id == $page->template_id ? 'selected' : '' }}>
                                {{ $template->name }}
                            </option>
                            @endforeach
                        </select>
