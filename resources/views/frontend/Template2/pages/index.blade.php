        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>About</h2>
                    <p>Results-driven Junior Laravel Developer with a
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="{{ asset('frontend/template2/assets') }}/img/profile-img.jpg" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-frontend">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('frontend/template2/assets') }}/img/portfolio/portfolio-1.jpg"
                                class="img-fluid" alt="">
                            <div class="portfolio-links">
                                <a href="{{ asset('frontend/template2/assets') }}/img/portfolio/portfolio-1.jpg"
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonials-carousel">
                    ...
                    <div class="testimonial-item" data-aos="fade-up">
                        ...
                        <img src="{{ asset('frontend/template2/assets') }}/img/testimonials/testimonials-1.jpg"
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <img src="{{ asset('frontend/template2/assets') }}/img/testimonials/testimonials-2.jpg"
                            class="testimonial-img" alt="">
                        <h3>Sara Wilsson</h3>
                        <h4>Designer</h4>
                    </div>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <img src="{{ asset('frontend/template2/assets') }}/img/testimonials/testimonials-3.jpg"
                            class="testimonial-img" alt="">
                        <h3>Jena Karlis</h3>
                        <h4>Store Owner</h4>
                    </div>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <img src="{{ asset('frontend/template2/assets') }}/img/testimonials/testimonials-4.jpg"
                            class="testimonial-img" alt="">
                        <h3>Matt Brandon</h3>
                        <h4>Freelancer</h4>
                    </div>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <img src="{{ asset('frontend/template2/assets') }}/img/testimonials/testimonials-5.jpg"
                            class="testimonial-img" alt="">
                        <h3>John Larson</h3>
                        <h4>Entrepreneur</h4>
                    </div>
