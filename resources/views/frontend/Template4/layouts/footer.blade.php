      ...
      <div class="container py-7 px-md-5">
        <div class="row g-0">
          <div class="col-md-6 mb-5 mb-md-0">
            <div class="mb-4 d-inline-block"><a class="navbar-brand pt-0 fs-3 text-white d-flex align-items-center" href="index.html"><img class="img-fluid" src="{{ asset('frontend/template4/assets/img/icons/dark-logo-icon.png')}}" alt="" width="25" height="25" /><span class="fw-bolder ms-2">Foto</span><span class="fw-thin">gency</span></a></div>
            ...
            <form>
              <div class="form-floating mb-5 position-relative text-200">
                ...
                <div class="position-absolute end-0 top-0">
                  <button class="btn shadow-none px-0" type="submit"><img class="ms-3" src="{{ asset('frontend/template4/assets/img/icons/long-arrow.png')}}" alt="" /></button>
                </div>
              </div>
            </form>
